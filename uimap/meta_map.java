...
public class meta_map {
	...
	public final static String username = "//input[@id='email']";
	public final static String password = "//input[@id='pass']";
	public final static String loginButton = "//button[@name='login']";
